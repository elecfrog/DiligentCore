    ...
    constexpr ShaderResourceVariableDesc Vars[] =
        {
            ...
            {SHADER_TYPE_PIXEL, "Var2", SHADER_RESOURCE_VARIABLE_TYPE_DYNAMIC, SHADER_VARIABLE_FLAG_GENERAL_INPUT_ATTACHMENT_VK},
        };
...
TEST(XXH128HasherTest, ShaderCreateInfo)
{
    ...
    TEST_STRINGS(WebGPUEmulatedArrayIndexSuffix, "Suffix 0", "Suffix 1", "Suffix 2");
}
