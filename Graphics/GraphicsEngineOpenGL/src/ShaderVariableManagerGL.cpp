...
IShaderResourceVariable* ShaderVariableManagerGL::GetVariable(UInt32 Index) const
{
    ...
    LOG_ERROR("{} is not a valid variable index.", Index);
    return nullptr;
}
...
UInt32 ShaderVariableManagerGL::GetVariableIndex(const IShaderResourceVariable& Var) const
{
    ...
    LOG_ERROR_MESSAGE("Failed to get variable index. The variable ", &Var, " does not belong to this shader variable manager");
    return ~0u;
}
