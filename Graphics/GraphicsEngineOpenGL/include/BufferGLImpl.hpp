...
public:
    ...
    virtual GLuint  GetGLBufferHandle() const override final { return GetGLHandle(); }

    /// Implementation of IBuffer::GetNativeHandle() in OpenGL backend.
    virtual UInt64  GetNativeHandle() override final { return BitCast<UInt64>(GetGLBufferHandle()); }
