...
public:
    ...
    IMPLEMENT_QUERY_INTERFACE_IN_PLACE(IID_TextureGL, TTextureBase)
    ...
    virtual GLuint  GetGLTextureHandle() const override final { return GetGLHandle(); }

    /// Implementation of ITexture::GetNativeHandle() in OpenGL backend.
    virtual UInt64  GetNativeHandle() override final { return BitCast<UInt64>(GetGLTextureHandle()); }
