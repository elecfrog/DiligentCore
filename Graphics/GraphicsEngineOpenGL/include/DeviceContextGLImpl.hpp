...
public:
    ...
    virtual void CALLTYPE GenerateMips(ITextureView* pTexView) override;
    ...
    virtual bool CALLTYPE UpdateCurrentGLContext() override final;

    /// Implementation of IDeviceContextGL::PurgeCurrentGLContextCaches().
    virtual void CALLTYPE PurgeCurrentGLContextCaches() override final;

    GLContextState& GetContextState() { return m_ContextState; }

    void CommitRenderTargets();

    virtual void CALLTYPE SetSwapChain(ISwapChainGL* pSwapChain) override final;
