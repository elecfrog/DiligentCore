...
public:
    ...
    virtual void DG_CALL_TYPE GenerateMips(ITextureView* pTexView) override;
    ...
    virtual bool DG_CALL_TYPE UpdateCurrentGLContext() override final;

    /// Implementation of IDeviceContextGL::PurgeCurrentGLContextCaches().
    virtual void DG_CALL_TYPE PurgeCurrentGLContextCaches() override final;

    GLContextState& GetContextState() { return m_ContextState; }

    void CommitRenderTargets();

    virtual void DG_CALL_TYPE SetSwapChain(ISwapChainGL* pSwapChain) override final;
