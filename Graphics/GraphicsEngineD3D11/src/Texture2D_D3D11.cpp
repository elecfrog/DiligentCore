...
// clang-format on
{
    ...
    UINT              D3D11BindFlags      = BindFlagsToD3D11BindFlags(m_Desc.BindFlags);
    ...
    if (*m_Desc.Name != 0)
    {
        HRESULT hr = m_pd3d11Texture->SetPrivateData(WKPDID_D3DDebugObjectName, static_cast<UINT>(strlen(m_Desc.Name)), m_Desc.Name);
