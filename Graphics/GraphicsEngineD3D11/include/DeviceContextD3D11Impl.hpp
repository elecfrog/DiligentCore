...
public:
    ...
    virtual void CALLTYPE ClearRenderTarget(ITextureView* pView, const void* RGBA, RESOURCE_STATE_TRANSITION_MODE StateTransitionMode) override final;
    ...
    virtual void CALLTYPE MapBuffer(IBuffer* pBuffer, MAP_TYPE MapType, MAP_FLAGS MapFlags, PVoid& pMappedData) override final;
    ...
    virtual void CALLTYPE GenerateMips(ITextureView* pTextureView) override final;
    ...
    virtual ICommandQueue* CALLTYPE LockCommandQueue() override final { return nullptr; }
    ...
    virtual ID3D11DeviceContext* CALLTYPE GetD3D11DeviceContext() override final { return m_pd3d11DeviceContext; }
