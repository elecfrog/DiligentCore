...
public:
    ...
    virtual ID3D11Resource*  GetD3D11Texture() const override final { return m_pd3d11Texture; }

    /// Implementation of ITexture::GetNativeHandle().
    virtual UInt64  GetNativeHandle() override final { return BitCast<UInt64>(GetD3D11Texture()); }
