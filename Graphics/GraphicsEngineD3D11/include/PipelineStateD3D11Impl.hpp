...
public:
    ...
    virtual ID3D11BlendState* GetD3D11BlendState() override final { return m_pd3d11BlendState; }

    /// Implementation of IPipelineStateD3D11::GetD3D11RasterizerState() method.
    virtual ID3D11RasterizerState* GetD3D11RasterizerState() override final { return m_pd3d11RasterizerState; }

    /// Implementation of IPipelineStateD3D11::GetD3D11DepthStencilState() method.
    virtual ID3D11DepthStencilState* GetD3D11DepthStencilState() override final { return m_pd3d11DepthStencilState; }

    /// Implementation of IPipelineStateD3D11::GetD3D11InputLayout() method.
    virtual ID3D11InputLayout* GetD3D11InputLayout() override final { return m_pd3d11InputLayout; }

    /// Implementation of IPipelineStateD3D11::GetD3D11VertexShader() method.
    virtual ID3D11VertexShader* GetD3D11VertexShader() override final { return GetD3D11Shader<ID3D11VertexShader>(VSInd); }

    /// Implementation of IPipelineStateD3D11::GetD3D11PixelShader() method.
    virtual ID3D11PixelShader* GetD3D11PixelShader() override final { return GetD3D11Shader<ID3D11PixelShader>(PSInd); }

    /// Implementation of IPipelineStateD3D11::GetD3D11GeometryShader() method.
    virtual ID3D11GeometryShader* GetD3D11GeometryShader() override final { return GetD3D11Shader<ID3D11GeometryShader>(GSInd); }

    /// Implementation of IPipelineStateD3D11::GetD3D11DomainShader() method.
    virtual ID3D11DomainShader* GetD3D11DomainShader() override final { return GetD3D11Shader<ID3D11DomainShader>(DSInd); }

    /// Implementation of IPipelineStateD3D11::GetD3D11HullShader() method.
    virtual ID3D11HullShader* GetD3D11HullShader() override final { return GetD3D11Shader<ID3D11HullShader>(HSInd); }

    /// Implementation of IPipelineStateD3D11::GetD3D11ComputeShader() method.
    virtual ID3D11ComputeShader* GetD3D11ComputeShader() override final { return GetD3D11Shader<ID3D11ComputeShader>(CSInd); }
