...
public:
    ...
    virtual ID3D11Buffer* GetD3D11Buffer() const override final { return m_pd3d11Buffer; }

    /// Implementation of IBuffer::GetNativeHandle().
    virtual UInt64 GetNativeHandle() override final { return BitCast<UInt64>(GetD3D11Buffer()); }
