...
public:
    ...
    virtual void  CreateShader(const ShaderCreateInfo& ShaderCreateInfo,
                                                 IShader**               ppShader,
    ...
    virtual void  CreateRenderPass(const RenderPassDesc& Desc,
    ...
    virtual void  CreatePipelineResourceSignature(const PipelineResourceSignatureDesc& Desc,
    ...
    virtual void  CreateDeviceMemory(const DeviceMemoryCreateInfo& CreateInfo,
                                                       IDeviceMemory**               ppMemory) override final;

    /// Implementation of IRenderDevice::CreatePipelineStateCache() in Vulkan backend.
    virtual void  CreatePipelineStateCache(const PipelineStateCacheCreateInfo& CreateInfo,
    ...
    virtual void  CreateDeferredContext(IDeviceContext** ppContext) override final;

    /// Implementation of IRenderDeviceVk::GetVkDevice().
    virtual VkDevice  GetVkDevice() override final { return m_LogicalDevice->GetVkDevice(); }
    ...
    virtual VkInstance  GetVkInstance() override final { return m_Instance->GetVkInstance(); }

    /// Implementation of IRenderDeviceVk::GetVkVersion().
    virtual UInt32  GetVkVersion() override final { return m_PhysicalDevice->GetVkVersion(); }
    ...
    virtual void  CreateBLASFromVulkanResource(VkAccelerationStructureKHR vkBLAS,
                                                                 const BottomLevelASDesc&   Desc,
                                                                 RESOURCE_STATE             InitialState,
                                                                 IBottomLevelAS**           ppBLAS) override final;

    /// Implementation of IRenderDeviceVk::CreateTLASFromVulkanResource().
    virtual void  CreateTLASFromVulkanResource(VkAccelerationStructureKHR vkTLAS,
                                                                 const TopLevelASDesc&      Desc,
                                                                 RESOURCE_STATE             InitialState,
                                                                 ITopLevelAS**              ppTLAS) override final;

    /// Implementation of IRenderDeviceVk::CreateFenceFromVulkanResource().
    virtual void  CreateFenceFromVulkanResource(VkSemaphore      vkTimelineSemaphore,
    ...
    virtual SparseTextureFormatInfo  GetSparseTextureFormatInfo(TEXTURE_FORMAT     TexFormat,
                                                                                  RESOURCE_DIMENSION Dimension,
                                                                                  UInt32             SampleCount) const override final;

    /// Implementation of IRenderDeviceVk::GetDeviceFeaturesVk().
    virtual void  GetDeviceFeaturesVk(DeviceFeaturesVk& FeaturesVk) const override final;

    /// Implementation of IRenderDeviceVk::GetDXCompiler().
    virtual IDXCompiler*  GetDXCompiler() const override final
    {
