...
public:
    ...
    virtual void  GetTileSize(UInt32& TileSizeX, UInt32& TileSizeY) override final;
    ...
    virtual void  ClearRenderTarget(ITextureView*                  pView,
                                                      const void*                    RGBA,
                                                      RESOURCE_STATE_TRANSITION_MODE StateTransitionMode) override final;
    ...
    virtual void  FinishCommandList(ICommandList** ppCommandList) override final;
    ...
    virtual VkCommandBuffer  GetVkCommandBuffer() override final;
