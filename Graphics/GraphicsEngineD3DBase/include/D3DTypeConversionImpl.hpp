...
D3D_PRIM_TOPOLOGY TopologyToD3DTopology(PRIMITIVE_TOPOLOGY Topology)
{
    ...
    if (!bIsInit)
    {
        ...
        d3dPrimTopology[PRIMITIVE_TOPOLOGY_TRIANGLE_LIST_ADJ]  = D3D_PRIMITIVE_TOPOLOGY_TRIANGLELIST_ADJ;
        d3dPrimTopology[PRIMITIVE_TOPOLOGY_TRIANGLE_STRIP_ADJ] = D3D_PRIMITIVE_TOPOLOGY_TRIANGLESTRIP_ADJ;
        d3dPrimTopology[PRIMITIVE_TOPOLOGY_LINE_LIST_ADJ]      = D3D_PRIMITIVE_TOPOLOGY_LINELIST_ADJ;
        d3dPrimTopology[PRIMITIVE_TOPOLOGY_LINE_STRIP_ADJ]     = D3D_PRIMITIVE_TOPOLOGY_LINESTRIP_ADJ;
