...
public:
                                         ...
                                         size_t /*inclusionDepth*/)
    {
        ...
        {
            DG_LOG_ERROR("Failed to open shader include file '", headerName, "'. Check that the file exists");
            return nullptr;
        }
                                      ...
                                      IDataBlob**             ppCompilerOutput)
{
    ...
    {
        DG_LOG_ERROR("Failed to legalize SPIR-V shader generated by HLSL front-end. This may result in undefined behavior.");
    }
#endif
    return SPIRV;
}
...
std::vector<unsigned int> GLSLtoSPIRV(const GLSLtoSPIRVAttribs& Attribs)
{
    ...
    {
        DG_LOG_ERROR("Failed to optimize SPIR-V.");
    }
#endif
    return SPIRV;
}
