...
TBuiltInResource InitResources()
{
    ...
    SPW_ASSERT_SIZEOF(Resources, 420, "Please initialize new members of Resources struct. Use glslang-default-resource-limits when this is tirggered.");
    ...
    SPW_ASSERT_SIZEOF(Resources.limits, 9, "Please initialize new members of Resources.limits struct. Use glslang-default-resource-limits when this is tirggered.");
