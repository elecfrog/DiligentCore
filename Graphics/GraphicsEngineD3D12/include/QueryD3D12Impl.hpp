...
public:
    ...
    virtual bool DG_CALL_TYPE GetData(void* pData, UInt32 DataSize, bool AutoInvalidate) override final;

    /// Implementation of IQuery::Invalidate().
    virtual void DG_CALL_TYPE Invalidate() override final;

    /// Implementation of IQueryD3D12::GetD3D12QueryHeap().
    virtual ID3D12QueryHeap* DG_CALL_TYPE GetD3D12QueryHeap() override final;

    /// Implementation of IQueryD3D12::GetQueryHeapIndex().
    virtual UInt32 DG_CALL_TYPE GetQueryHeapIndex(UInt32 QueryId) const override final
    {
