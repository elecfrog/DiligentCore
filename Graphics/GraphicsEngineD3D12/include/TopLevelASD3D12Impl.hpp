...
public:
    ...
    virtual ID3D12Resource* GetD3D12TLAS() override final { return GetD3D12Resource(); }

    /// Implementation of ITopLevelASD3D12::GetNativeHandle() in Direct3D12 backend.
    virtual UInt64 GetNativeHandle() override final { return BitCast<UInt64>(GetD3D12TLAS()); }
