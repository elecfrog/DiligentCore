...
public:
    ...
    virtual DeviceMemoryRangeD3D12  GetRange(UInt64 Offset, UInt64 Size) const override final;

    /// Implementation of IDeviceMemoryD3D12::IsUsingNVApi().
    virtual Bool  IsUsingNVApi() const override final { return m_UseNVApi; }
