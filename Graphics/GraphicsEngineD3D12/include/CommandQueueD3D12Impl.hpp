...
public:
    ...
    virtual UInt64  Submit(UInt32                    NumCommandLists,
    ...
    virtual void  EnqueueSignal(ID3D12Fence* pFence, UInt64 Value) override final;

    // Implementation of ICommandQueueD3D12::WaitFence().
    virtual void  WaitFence(ID3D12Fence* pFence, UInt64 Value) override final;

    // Implementation of ICommandQueueD3D12::GetD3D12CommandQueueDesc().
    virtual const D3D12_COMMAND_QUEUE_DESC&  GetD3D12CommandQueueDesc( ) const override final
    {
        return m_d3d12CmdQueueDesc;
    }

    // Implementation of ICommandQueueD3D12::UpdateTileMappings().
    virtual void  UpdateTileMappings(ResourceTileMappingsD3D12* pMappings,
