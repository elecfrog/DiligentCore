...
public:
    ...
    virtual void  CreateSampler(const SamplerDesc& SamplerDesc,
    ...
    virtual ID3D12Device*  GetD3D12Device() const override final { return m_pd3d12Device; }
    ...
    virtual void  CreateBLASFromD3DResource(ID3D12Resource*          pd3d12BLAS,
                                                              const BottomLevelASDesc& Desc,
                                                              RESOURCE_STATE           InitialState,
                                                              IBottomLevelAS**         ppBLAS) override final;

    /// Implementation of IRenderDeviceD3D12::CreateTLASFromD3DResource().
    virtual void  CreateTLASFromD3DResource(ID3D12Resource*       pd3d12TLAS,
