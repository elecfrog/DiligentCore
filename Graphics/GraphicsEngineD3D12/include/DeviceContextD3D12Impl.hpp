...
public:
    ...
    virtual void CALLTYPE TransitionTextureState(ITexture* pTexture, D3D12_RESOURCE_STATES State) override final;

    /// Implementation of IDeviceContext::TransitionBufferState() in Direct3D12 backend.
    virtual void CALLTYPE TransitionBufferState(IBuffer* pBuffer, D3D12_RESOURCE_STATES State) override final;
    ...
    virtual ID3D12GraphicsCommandList* CALLTYPE GetD3D12CommandList() override final;
