...
public:
    ...
    virtual ID3D12Resource* DG_CALL_TYPE GetD3D12Buffer(UInt64& DataStartByteOffset, IDeviceContext* pContext) override final;

    /// Implementation of IBuffer::GetNativeHandle().
    virtual UInt64 DG_CALL_TYPE GetNativeHandle() override final
    {
