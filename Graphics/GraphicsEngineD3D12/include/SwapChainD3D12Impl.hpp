...
public:
    ...
    virtual ITextureViewD3D12* DG_CALL_TYPE GetCurrentBackBufferRTV() override final
    {
    ...
    virtual ITextureViewD3D12* DG_CALL_TYPE GetDepthBufferDSV() override final { return m_pDepthBufferDSV; }
