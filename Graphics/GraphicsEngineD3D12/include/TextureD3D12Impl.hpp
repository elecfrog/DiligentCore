...
public:
    ...
    virtual ID3D12Resource*  GetD3D12Texture() const override final { return GetD3D12Resource(); }

    /// Implementation of ITexture::GetNativeHandle() in Direct3D12 backend.
    virtual UInt64  GetNativeHandle() override final { return BitCast<UInt64>(GetD3D12Texture()); }
