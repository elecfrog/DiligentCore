...
public:
    ...
    bool DG_CALL_TYPE LoadD3D12(const char* DllName) override final;

    virtual void DG_CALL_TYPE CreateDeviceAndContextsD3D12(const EngineD3D12CreateInfo& EngineCI,
                                                                 IRenderDevice**              ppDevice,
                                                                 IDeviceContext**             ppContexts) override final;

    virtual void DG_CALL_TYPE CreateCommandQueueD3D12(void*                pd3d12NativeDevice,
                                                            void*                pd3d12NativeCommandQueue,
                                                            IMemoryAllocator*    pRawMemAllocator,
                                                            ICommandQueueD3D12** ppCommandQueue) override final;

    virtual void DG_CALL_TYPE AttachToD3D12Device(void*                        pd3d12NativeDevice,
    ...
    virtual void DG_CALL_TYPE CreateSwapChainD3D12(IRenderDevice*            pDevice,
    ...
    virtual void DG_CALL_TYPE EnumerateAdapters(Version              MinFeatureLevel,
                                                      UInt32&              NumAdapters,
                                                      GraphicsAdapterInfo* Adapters) const override final;

    virtual void DG_CALL_TYPE EnumerateDisplayModes(Version             MinFeatureLevel,
                                                          UInt32              AdapterId,
                                                          UInt32              OutputId,
