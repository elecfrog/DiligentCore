...
public:
    ...
    virtual void  CreateCommandQueueD3D12(void*                pd3d12NativeDevice,
    ...
    virtual void  EnumerateAdapters(Version              MinFeatureLevel,
                                                      UInt32&              NumAdapters,
                                                      GraphicsAdapterInfo* Adapters) const override final;

    virtual void  EnumerateDisplayModes(Version             MinFeatureLevel,
                                                          UInt32              AdapterId,
                                                          UInt32              OutputId,
