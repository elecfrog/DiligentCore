...
bool PRSSerializerWebGPU<Mode>::SerializeInternalData(
    Serializer<Mode>&                                       Ser,
...
template struct PRSSerializerWebGPU<SerializerMode::Read>;
template struct PRSSerializerWebGPU<SerializerMode::Write>;
template struct PRSSerializerWebGPU<SerializerMode::Measure>;
