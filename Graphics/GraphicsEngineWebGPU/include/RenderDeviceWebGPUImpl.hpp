...
public:
    ...
    void  CreateRayTracingPipelineState(const RayTracingPipelineStateCreateInfo& PSOCreateInfo,
                                                          IPipelineState**                         ppPipelineState) override final;

    /// Implementation of IRenderDevice::CreateFence() in WebGPU backend.
    void  CreateFence(const FenceDesc& Desc,
                                        IFence**         ppFence) override final;

    /// Implementation of IRenderDevice::CreateQuery() in WebGPU backend.
    void  CreateQuery(const QueryDesc& Desc,
    ...
    void  CreateDeviceMemory(const DeviceMemoryCreateInfo& CreateInfo,
                                               IDeviceMemory**               ppMemory) override final;

    /// Implementation of IRenderDevice::CreatePipelineStateCache() in WebGPU backend.
    void  CreatePipelineStateCache(const PipelineStateCacheCreateInfo& CreateInfo,
    ...
    void  ReleaseStaleResources(bool ForceRelease = false) override final {}

    /// Implementation of IRenderDevice::IdleGPU() in WebGPU backend.
    void  IdleGPU() override final;
