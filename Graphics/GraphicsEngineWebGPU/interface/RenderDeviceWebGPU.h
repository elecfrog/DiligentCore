...
static constexpr INTERFACE_ID IID_RenderDeviceWebGPU =
...
DILIGENT_BEGIN_INTERFACE(IRenderDeviceWebGPU, IRenderDevice)
{
    ...
    virtual WGPUInstance METHOD(GetWebGPUInstance)( ) const =0;

    /// Returns WebGPU adapter
    virtual WGPUAdapter METHOD(GetWebGPUAdapter)( ) const =0;

    /// Returns WebGPU device
    virtual WGPUDevice METHOD(GetWebGPUDevice)( ) const =0;
    ...
    virtual void METHOD(CreateTextureFromWebGPUTexture)(
    ...
    ///        in use by the engine.
    virtual void METHOD(CreateBufferFromWebGPUBuffer)(
