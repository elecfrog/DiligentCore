...
/// \file
/// Definition of the Diligent::IShaderResourceBindingWebGPU interface
...
//  IShaderResourceBindingWebGPUMethods ShaderResourceBindingWebGPU
...
typedef struct IShaderResourceBindingWebGPUVtbl
{
    IShaderResourceBindingWebGPUInclusiveMethods;
} IShaderResourceBindingWebGPUVtbl;
