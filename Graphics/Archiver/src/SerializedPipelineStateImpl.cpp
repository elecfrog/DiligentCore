...
UInt32 SerializedPipelineStateImpl::GetPatchedShaderCount(ARCHIVE_DEVICE_DATA_FLAGS DeviceType) const
{
...
ShaderCreateInfo SerializedPipelineStateImpl::GetPatchedShaderCreateInfo(
