...
UInt32 DG_CALL_TYPE SerializedPipelineStateImpl::GetPatchedShaderCount(ARCHIVE_DEVICE_DATA_FLAGS DeviceType) const
{
...
ShaderCreateInfo DG_CALL_TYPE SerializedPipelineStateImpl::GetPatchedShaderCreateInfo(
