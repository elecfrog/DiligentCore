...
public:
    ...
    virtual const ShaderDesc& GetDesc() const override final { return m_CreateInfo.Get().Desc; }
    ...
    virtual IShader*      GetDeviceShader(RENDER_DEVICE_TYPE Type) const override final;
