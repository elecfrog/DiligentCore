...
public:
    ...
    virtual const ShaderDesc& DG_CALL_TYPE GetDesc() const override final { return m_CreateInfo.Get().Desc; }
    ...
    virtual IShader* DG_CALL_TYPE      GetDeviceShader(RENDER_DEVICE_TYPE Type) const override final;
