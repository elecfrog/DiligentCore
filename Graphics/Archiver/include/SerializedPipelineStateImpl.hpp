...
public:
    ...
    virtual UInt32 DG_CALL_TYPE GetPatchedShaderCount(ARCHIVE_DEVICE_DATA_FLAGS DeviceType) const override final;

    virtual ShaderCreateInfo DG_CALL_TYPE GetPatchedShaderCreateInfo(
