...
static constexpr UInt32 MAX_LAYOUT_ELEMENTS        = DILIGENT_MAX_LAYOUT_ELEMENTS;
static constexpr UInt32 LAYOUT_ELEMENT_AUTO_OFFSET = DILIGENT_LAYOUT_ELEMENT_AUTO_OFFSET;
static constexpr UInt32 LAYOUT_ELEMENT_AUTO_STRIDE = DILIGENT_LAYOUT_ELEMENT_AUTO_STRIDE;
