...
static constexpr UInt32 MAX_BUFFER_SLOTS        = DILIGENT_MAX_BUFFER_SLOTS;
static constexpr UInt32 MAX_RENDER_TARGETS      = DILIGENT_MAX_RENDER_TARGETS;
static constexpr UInt32 MAX_VIEWPORTS           = DILIGENT_MAX_VIEWPORTS;
static constexpr UInt32 MAX_RESOURCE_SIGNATURES = DILIGENT_MAX_RESOURCE_SIGNATURES;
static constexpr UInt32 MAX_ADAPTER_QUEUES      = DILIGENT_MAX_ADAPTER_QUEUES;
static constexpr UInt32 DEFAULT_ADAPTER_ID      = DILIGENT_DEFAULT_ADAPTER_ID;
static constexpr UInt8  DEFAULT_QUEUE_ID        = DILIGENT_DEFAULT_QUEUE_ID;
static constexpr UInt32 MAX_SHADING_RATES       = DILIGENT_MAX_SHADING_RATES;
static constexpr UInt32 SHADING_RATE_X_SHIFT    = DILIGENT_SHADING_RATE_X_SHIFT;
